...
type ECDSAAPI interface {
	...
	//
	// CAVEAT: Only use the public key, e.g., for creating an address on a blockchain, if you trust this player.
	...
	//
	// CAVEAT: Only use the chain code if you trust this player. External parties should generally only trust a chain
	// code from the TSM, e.g. use it to construct a blockchain address, if it was obtained from at least threshold + 1
	// different players, and all the obtained chain codes are identical.
	//
	// Input:
