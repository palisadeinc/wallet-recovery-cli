...
var lagrangeCache caching.Cache
var lagrangeCacheInit sync.Once
...
func Lagrange(s ec.Scalar, t int, xs []ec.Scalar) []ec.Scalar {
	...
	lagrangeCacheInit.Do(func() {
		lagrangeCache = caching.NewLRUCache(lagrangeCoefficientsCacheSize)
	})
